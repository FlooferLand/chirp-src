...
public class TimeLength {
    ...
    public static TimeLength ofMidiTicks(@NotNull Sequence sequence, long ticks, double bpm) {
    ...
    public TimeLength lerp(@NotNull TimeLength target, double t) {
    ...
    public static TimeLength between(@NotNull TimeLength a, @NotNull TimeLength b) {
        return a.lerp(b, 0.5);
    }
    // endregion
